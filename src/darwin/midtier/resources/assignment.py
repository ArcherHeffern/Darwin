...
from darwin.models.midtier_models import Assignment, BasicAssignment, CreateAssignment, CourseId, AssignmentId
...
@router.get("/")
def get_assignments(course_id: Optional[CourseId] = None, hide_deleted: bool = True) -> list[BasicAssignment]:
